...
;;    dropped-olivetti-shrink C-c { { { ...
;;    dropped-olivetti-expand C-c } } } ...
;;    dropped-olivetti-set-width C-c |
;;  - If dropped-olivetti-body-width is an integer, the text body width will
;;    scale with use of text-scale-mode, whereas if a fraction (float) then
;;    the text body width will remain at that fraction.
;;  - Change the way the text body margins look with option dropped-olivetti-style: use
;;    margins, fringes, or both for a fancy "page" look.
;;  - Customize dropped-olivetti-fringe face to affect only Dropped-Olivetti buffers.
;;  - Optionally remember the state of visual-line-mode on entry and
;;    recall its state on exit.

;; Dropped-Olivetti keeps everything it does buffer-local, so you can write prose
...
;; The latest stable release of Dropped-Olivetti is available via
...
;; You can then find the latest stable version of dropped-olivetti in the
;; list returned by:
...
;;     (require 'dropped-olivetti)

;; If you wish to contribute to or alter Dropped-Olivetti's code, clone the
;; repository into your load-path and require as above:

;;     git clone https://github.com/rnkn/dropped-olivetti.git
...
;;     M-x add-file-local-variable RET dropped-olivetti-body-width RET 66 RET
...
;; [1]: https://stable.melpa.org/#/dropped-olivetti
;; [2]: https://melpa.org/#/dropped-olivetti
